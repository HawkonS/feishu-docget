...
def process_document(doc_url, template_path=None, table_style=None, base_dir='.', output_root='output', progress_cb=None, add_cover=False, check_stop_func=None, unordered_list_style='default', body_style=None, image_style=None, ignore_mention=False, table_config=None, margin_config=None):
    ...
    try:
        ...
        try:
            clean_document(docx_path, progress_cb=progress_cb, template_path=template_path, add_cover=add_cover, body_style=body_style, image_style=image_style, table_config=table_config, margin_config=margin_config)
        except Exception as e:
